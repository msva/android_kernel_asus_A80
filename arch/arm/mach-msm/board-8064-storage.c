...
//ASUS_BSP +++ Josh_Liao "tuning sdc1 driving strength for A80"
	...
	pr_info("[mmc] SDC1_CLK:%d, SDC1_CMD:%d, SDC1_DATA:%d \n", apq8064_sdc1_pdata->pin_data->pad_data->drv->on[0].val
		, apq8064_sdc1_pdata->pin_data->pad_data->drv->on[1].val , apq8064_sdc1_pdata->pin_data->pad_data->drv->on[2].val);
//ASUS_BSP --- Josh_Liao "tuning sdc1 driving strength for A80"
	if (apq8064_sdc1_pdata)
