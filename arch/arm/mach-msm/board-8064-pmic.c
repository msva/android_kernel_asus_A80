...
//ASUS_BSP ---
	PM8921_GPIO_INPUT(5, PM_GPIO_PULL_UP_30),   //ASUS_BSP:Louis, a80 LCD id pin
	...
	//PM8921_GPIO_INPUT(12, PM_GPIO_PULL_UP_30),     /* PCIE_WAKE_N */ //ASUS_BSP LiJen: set default value
	PM8921_GPIO_OUTPUT(12, 0, LOW),		//ASUS_BSP LiJen: set default value
};
...
apq8064_pm8921_platform_data __devinitdata = {
	...
	.vibrator_pdata = &pm8xxx_vibrator_pdata //ASUS BSP Austin+
};
...
//austin++
	if( g_A68_hwID >= A80_EVB && g_A68_hwID <= A80_PR ){ //A80
		pm8xxx_vibrator_pdata.level_mV = 3000;
	}
	else if( g_A68_hwID >= A68_EVB && g_A68_hwID <= A68_CD ){ //A68
		pm8xxx_vibrator_pdata.level_mV = 2000;
	}
	else{
		printk("%s:unknown hwID",__func__);
	}
//austin--
