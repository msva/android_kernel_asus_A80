			...
			size_t size, unsigned int protflags)
{
	...
	/* The following two ENOMEM error handling will occur BUG_ON in kgsl_sharedmem_free
	->kgsl_sg_free->kfree, which need correct memdesc->sglen, 
	so assign it before goto done section */
	memdesc->sglen = sglen;
	...
	/* The following ENOMEM error handling will occur data abort in 
	kgsl_sharedmem_free->kgsl_page_alloc_free->__free_pages,
	so init memdesc->sg before goto done section */
