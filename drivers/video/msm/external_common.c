...
struct hdmi_disp_mode_timing_type
    ...
    VFRMT_NOT_SUPPORTED(HDMI_VFRMT_1920x1200p60_16_10),//ASUS_BSP: joe1_++: support resolution 1920X1200
};
...
#endif
    if (g_A68_hwID < A80_SR3 && !MHL_PP_Mode && (video_format == HDMI_VFRMT_1920x1080p50_16_9 || video_format == HDMI_VFRMT_1920x1080p60_16_9))
	{
	      return;
	}
...
//ASUS_BSP: joe1_--: support resolution 1920X1200
            external_common_state->default_res_supported = true;//Mickey+++, set default res support enabled
        } else {
...
void hdmi_common_init_panel_info(struct msm_panel_info *pinfo)
{
	...
	/* blue */
    pinfo->lcdc.underflow_clr = 0x0;//Mickey+++,change to black!
